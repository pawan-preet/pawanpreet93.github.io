...
(function(e) {
    ...
    function S(a, b, c) {
        ...
        cur_scale = "1";
        void 0 != a.attr("data-final-scale") && "" != a.attr("data-final-scale") && (cur_scale = a.attr("data-final-scale")); - 1 != p && 10 > p ? (a.css({
            ...
            void 0 != a.attr("data-intermediate-left") && "" != a.attr("data-intermediate-left") && (h = a.attr("data-intermediate-left"), g = a.attr("data-intermediate-top"), c.responsive && (h = parseInt(h / (c.origWidth / c.width), 10), g = parseInt(g / (c.origWidth / c.width), 10)), b.timeouts_arr[b.timeouts_arr.length] = setTimeout(function() {
                ...
                a.stop().animate({
                    ...
                    left: h + "px",
                    top: g + "px"
                }, 1E3 * a.attr("data-intermediate-duration"), G(a.attr("data-intermediate-easing")), function() {})
            ...
            "-webkit-transition-timing-function": s(l),
            "-moz-transition-timing-function": s(l),
            "-ms-transition-timing-function": s(l),
            "-o-transition-timing-function": s(l),
            "transition-timing-function": s(l)
        }), void 0 != a.attr("data-intermediate-left") && "" != a.attr("data-intermediate-left") && (h = a.attr("data-intermediate-left"), g = a.attr("data-intermediate-top"), c.responsive && (h = parseInt(h / (c.origWidth / c.width), 10), g = parseInt(g / (c.origWidth / c.width), 10)), b.timeouts_arr[b.timeouts_arr.length] = setTimeout(function() {
            cur_skew = "0deg,0deg";
            void 0 != a.attr("data-intermediate-skew") && "" != a.attr("data-intermediate-skew") && (cur_skew = a.attr("data-intermediate-skew"));
            cur_scale = "1";
            ...
            a.css({
                ...
                "-webkit-transition-timing-function": s(a.attr("data-intermediate-easing")),
                "-moz-transition-timing-function": s(a.attr("data-intermediate-easing")),
                "-ms-transition-timing-function": s(a.attr("data-intermediate-easing")),
                "-o-transition-timing-function": s(a.attr("data-intermediate-easing")),
                "transition-timing-function": s(a.attr("data-intermediate-easing"))
            })
    ...
    function Z(a, b, c, p) {
        ...
        c.each(function() {
            ...
            0 < l ? a.timeouts_arr[a.timeouts_arr.length] = setTimeout(function() {
                ...
                cur_scale = "1";
                void 0 != c.attr("data-exit-scale") && "" != c.attr("data-exit-scale") && (cur_scale = c.attr("data-exit-scale")); - 1 != f && 10 > f ? (c.css({
                    "-webkit-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")",
                    "-moz-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")",
                    "-ms-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")",
                    "-o-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")",
                    ...
                    left: h + "px",
                    top: g + "px"
                }, 1E3 * l, B, function() {}), 8 == f && c.find("img:first").is("img") && c.find("img:first").animate({
                    opacity: t
                }, 1E3 * l, B, function() {})) : c.css({
                    opacity: t,
                    "-webkit-transform": "translate(" + h + "px," + g + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")",
                    "-moz-transform": "translate(" + h + "px," + g + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")",
                    "-ms-transform": "translate(" + h + "px," + g + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")",
                    ...
                    "-webkit-transition-timing-function": s(B),
                    "-moz-transition-timing-function": s(B),
                    "-ms-transition-timing-function": s(B),
                    "-o-transition-timing-function": s(B),
                    "transition-timing-function": s(B)
                })
            }, 1E3 * p) : "false" == q && c.css({
                display: "none"
            });
    ...
    function K(a, b, c, p, f, n, m, h, g, l, r, t, q, B, w, u) {
        var v = E(),
            s = !0;
        if (!c.loop && b.current_img_no + a >= b.total_images || !c.loop && 0 > b.current_img_no + a) s = !1;
        s && !b.slideIsRunning && b.firstLoadingComplete && (b.slideIsRunning = !0, I(b.timeouts_arr), M(b.continuouseIntervalIDs), $(b.rotationFunctionsArr, b), Z(b, c, n, m), b.arcInitialTime = (new Date).getTime(), b.timeElapsed = 0, c.showCircleTimer && (clearInterval(b.intervalID), b.ctx.clearRect(0, 0, b.canvas.width, b.canvas.height), b.ctx.beginPath(), b.ctx.globalAlpha = c.behindCircleAlpha / 100, b.ctx.arc(c.circleRadius + 2 * c.circleLineWidth, c.circleRadius + 2 * c.circleLineWidth, c.circleRadius, 0, 2 * Math.PI, !1), b.ctx.lineWidth = c.circleLineWidth + 2, b.ctx.strokeStyle = c.behindCircleColor, b.ctx.stroke(), b.ctx.beginPath(), b.ctx.globalAlpha = c.circleAlpha / 100, b.ctx.arc(c.circleRadius + 2 * c.circleLineWidth, c.circleRadius + 2 * c.circleLineWidth, c.circleRadius, 0, 0, !1), b.ctx.lineWidth = c.circleLineWidth, b.ctx.strokeStyle = c.circleColor, b.ctx.stroke(), b.intervalID = setInterval(function() {
            ...
            L(b, b.currentImg, c, n, g, m, !1); - 1 != v && 10 > v && b.previous_imgInside.css("filter", 'progid:DXImageTransform.Microsoft.Matrix(FilterType="bilinear",M11=1, M12=0, M21=0, M22=1, Dx=0, Dy=0)')
        })) : h.animate({
    ...
    function ba(a, b, c, p, f, n, m, h, g, l, r, t, q, s, w, u, v, z, d, F, E, y) {
        ...
        if (b.origWidth != responsiveWidth || b.width100Proc) {
            ...
            for (i = 0; i < a.total_images; i++) N(i, b, h, a.origImgsDimensions, c), t = b.fadeSlides ? 0 : parseInt(i * b.width, 10), e(e(c[i]).attr("data-text-id")).css({
                width: p.width() + "px",
                left: t,
                top: f.css("top")
            });
            ...
            "opportune" == b.skin ? (d.css({
                ...
                top: b.height + "px"
            }), b.width100Proc && b.height100Proc || d.css("margin-top", parseInt(b.thumbsWrapperMarginTop / (b.origWidth / b.width), 10) + "px")) : Y(a, b, h, r, q, s, w, u, F, E);
            g.css({
            ...
            1 < a.total_images ? y.click() : (e("#contentHolderUnit_" + a.current_img_no, h).html(e(c[a.previous_current_img_no]).html()), N(a.current_img_no, b, h, a.origImgsDimensions, c), I(a.timeouts_arr), e(".newFS", h).contents().unwrap(), L(a, a.currentImg, b, p, h, f, !1), b.fadeSlides && e("#contentHolderUnit_" + a.current_img_no, h).css({
                opacity: 1,
                "z-index": 0,
                display: "block"
            }), setTimeout(function() {
    ...
    e.fn.bannerscollection_zoominout = function(a) {
        ...
        return this.each(function() {
            ...
            var c = e("<div></div>").addClass("bannerscollection_zoominout").addClass(a.skin),
                p = e('<div class="bannerControls"> <div class="leftNav" style="display:block !important;z-index:999;"></div> <div class="rightNav" style="display:block !important;z-index:999; margin-right:-30px"></div> </div> <div class="contentHolderVisibleWrapper" style="width:100%; max-height:900px !important;"><div class="contentHolder"  style="width:100%; max-height: 900px !important;"></div></div> <div class="playOver"></div> <div class="thumbsHolderWrapper"><div class="thumbsHolderVisibleWrapper"><div class="thumbsHolder"></div></div></div> <canvas class="mycanvas"></canvas>');
            b.wrap(c);
            b.after(p);
            ...
            var q = e(".thumbsHolderWrapper", f),
                s = e(".thumbsHolderVisibleWrapper", f),
                w = e(".thumbsHolder", f),
                u, v;
            ...
            a.showBottomNav && a.showOnInitBottomNav || q.css({
                opacity: 0,
                display: "none"
            });
            "opportune" != a.skin && q.css("margin-top", parseInt(a.thumbsWrapperMarginTop / (a.origWidth / a.width), 10) + "px");
            c = E();
            a.enableTouchScreen && (a.fadeSlides && (p = Math.floor(1E5 * Math.random()), f.wrap('<div id="zoominoutParent_' + p + '" style="position:relative; width:100%; max-height:900px !important;" />'), e("#zoominoutParent_" + p).height(a.height)), -1 != c && 9 == c && a.fadeSlides && "opportune" == a.skin || (h.css("cursor", "url(" + a.absUrl + "skins/hand.cur),url(" + a.absUrl + "skins/hand.cur),move"),f.css("max-height", "900px"), f.css("cursor", "url(" + a.absUrl + "skins/hand.cur),url(" + a.absUrl + "skins/hand.cur),move")), h.css("left", "0"), a.fadeSlides ? -1 != c && 9 == c && a.fadeSlides && "opportune" == a.skin || f.draggable({
                axis: "x",
                containment: "parent",
                distance: 10,
                start: function(a, b) {
            ...
            var y = c.children(),
                ...
                A, x, U = 0,
                O = 0,
                S = '<img src="' + a.absUrl + 'skins/empty.png" alt="" width="1" height="1" />';
            y.each(function() {
                d.currentImg = e(this);
            ...
            f.mouseenter(function() {
                ...
                a.autoHideBottomNav && a.showBottomNav && ("opportune" == a.skin ? r.css({
                    display: "block",
                    left: parseInt((f.width() - P) / 2, 10) + "px"
                }) : 0 > a.thumbsWrapperMarginTop && d.isVideoPlaying || !a.showBottomNav || (q.css({
                    display: "block"
                }), q.stop().animate({
                    opacity: 1
                }, 500, "swing", function() {})))
            ...
            f.mouseleave(function() {
                ...
                a.autoHideBottomNav && a.showBottomNav && ("opportune" == a.skin ? r.css("display", "none") : q.stop().animate({
                    opacity: 0
                }, 300, "swing", function() {}));
            ...
            g.click(function() {
                d.slideIsRunning || (d.isVideoPlaying = !1, a.showBottomNav && (q.css({
                    opacity: 1,
                    display: "block"
                }), "opportune" == a.skin && r.css("display", "block")), clearTimeout(d.timeoutID), K(-1, d, a, D, y, b, n, h, f, z, F, C, w, u, v, x))
            });
            l.click(function() {
                d.slideIsRunning || (d.isVideoPlaying = !1, a.showBottomNav && (q.css({
                    opacity: 1,
            ...
            "opportune" == a.skin && (D.click(function() {
                ...
                if (a.showPreviewThumbs) {
                    ...
                    b.append(t);
                    var d = e(y[c]).attr("data-bottom-thumb"),
                        f = e(y[G]).attr("data-bottom-thumb"),
                        g = 80,
                        h = -80;
                    G > c && (g = -80, h = 80);
                    t.html("");
