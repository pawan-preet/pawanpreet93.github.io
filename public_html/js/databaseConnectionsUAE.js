...
var ctx1 = document.getElementsByClassName("graphArea")[1].getContext("2d");
		window.myBar = new Chart(ctx1).Line(lineChartData, {
			responsive : true,scaleShowGridLines: false,showTooltips: false,showScale: true,scaleLineColor: "transparent",pointDot : false, showXLabels: 5,scaleLabel : "<%= value + ' kW '%>"});
			}
			else{
...
document.getElementsByClassName("billSavingUAE")[0].innerHTML =  parseInt(value * 0.44);
...
document.getElementsByClassName("billSavingUAE")[1].innerHTML =  parseInt(value * 0.44);
