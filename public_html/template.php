...
<meta name="google-site-verification" content="TUGyp8r00lrvV0yhttmPVpLmGReSU2g4ZGJhSkvPlhI" />
...
-->
<!--**************************************** NEW WORK ********************************************-->
                           <!--<ul class="dropdown-menu" style="left:0" role="OthersMenu" id="othersmenu">
			...
			<li><a href="Consult.php" class="nav-opt-lg">Consultancy</a></li>-->
                        ...
                        <li><a href="faq.php" class="nav-opt-sm">FAQ</a></li>
                         ...
                         <li class="dropdown" style="padding-top:10px;">
                            <a href="#" class="dropdown-toggle nav-opt-lg" data-toggle="dropdown" role="button" aria-expanded="false" style="background:#007aff;height:30px;width:80px;padding-top:3px"><span style="color:white; font-size:17px; font-weight:200">UAE</span><span style="color:white" class="caret"></span></a>

                           <ul class="dropdown-menu" style="width:50px !important;">
<li style="width:80px;padding:0px"><a  href="/india" style="width:80px;padding:0px" class="nav-opt-lg" ><span style="color:#00b050;font-size:17px;padding:0px">INDIA</span></a></li>
</ul>
</li>
                    </ul>
                </div>
...
<div id="termsPrivacySectionMobile" style="padding-top:50px;  background-color:black; text-align:center; font-family: Calibri, Candara, Segoe, 'Segoe UI', Optima, Arial, sans-serif;">
                    <a href="http://www.clenergize.com/uae/terms.php" style="color:white;" target="_blank" class="social-link">Terms of Use</a>
                    <a href="http://www.clenergize.com/uae/privacy.php" style="color:white;" target="_blank" class="social-link">Privacy Policy</a>
                </div>
...
<div class="col-sm-6"  id="termsPrivacySection" style="text-align:right; font-family: Calibri, Candara, Segoe, 'Segoe UI', Optima, Arial, sans-serif;">
                    <a href="http://www.clenergize.com/uae/terms.php" target="_blank" class="social-link">Terms of Use</a>
                    <a href="http://www.clenergize.com/uae/privacy.php" target="_blank" class="social-link">Privacy Policy</a>
                </div>
            </div>
...
Business Center DWC<br>
Dubai, PO Box 390667<br>
                        Email: <a href="mailto:info@clenergize.com">info@clenergize.com</a><br/>
                        <span style="font-size: 20px;">Office: +9714 456 0538</span><br/>
						<span style="font-size: 20px;">Mobile: +971 555 777 069</span><br/>
                    </p>
                </div>
            </div>
