...
$(document).ready(function(){
    window.location="http://clenergize.com"
});
...
<li style="width:80px;padding:0px" class="switch"><a  href="#" style="width:80px;padding:0px" class="nav-opt-lg" ><span style="color:#00b050;font-size:17px;padding:0px">INDIA</span></a></li>
</ul>
</li>
                    </ul>
                </div>
...
Dubai, PO Box 390667<br>
                        ...
                        <span style="font-size: 24px;">Phone: +971 555 777 069</span><br/>
                    </p>
                </div>
            </div>
